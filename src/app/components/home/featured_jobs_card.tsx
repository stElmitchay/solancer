...
const FeaturedJobCard = ({
    ...
    return (
        <div>
            <div className='bg-[#C8EEEE] h-96 max-w-sm py-8 px-8 rounded-3xl flex flex-col justify-between'>
                <div className="flex flex-col justify-center">
                    ...
                    <h1 className='text-center font-semibold'>{profession}</h1>
                    <h5 className='text-center text-sm font-light'>{company}</h5>

                    <div className="flex flex-col mt-8 space-y-4">
                        <span className="flex items-center">
                            <PiCurrencyCircleDollarDuotone className="size-5" />
                            <h5 className="ml-2 font-light">${minSalary} - ${maxSalary} <span className="ml-6 text-slate-400">/monthly</span></h5>
                        </span>
                        <span className="flex items-center">
                            <PiMapPinDuotone className="size-5" />
                            <h5 className="ml-2 font-light">
                                {location}
